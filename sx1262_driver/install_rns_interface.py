...
Installs the SX1262Interface.py wrapper into ~/.reticulum/interfaces/ and
writes a starter ~/.reticulum/config if one does not already exist.
...
def main():
    ...
    wrapper_dest = os.path.join(interfaces_dir, "SX1262Interface.py")
